...
export default {
  ...
  methods:{
    getResults(searchedText){
      axios.get(`https://api.themoviedb.org/3/search/movie?api_key=7cf13cd92f233be2d474cd7b4c1399b5&language=en-US&query=${searchedText}&page=1&include_adult=false`, {
        params: {
          title: searchedText,
        }
      })
